"""
CartPole: train a conditional NF for transitions and an NF for the initial
...
def main() -> None:
    ...
    if fig is not None:
        fig.suptitle("cartpole - particle NF marginal comparison", y=1.02)
