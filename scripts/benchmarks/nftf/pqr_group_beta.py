...
def main() -> None:
    ...
    def experiment(
        ...
        variance = 1.0
        phi_basis = UnnormalizedBetaBasis.random_init(
            system.dim(),
            n_basis=n_basis,
            offsets=offsets,
            variance=variance,
        ...
        psi_basis = UnnormalizedBetaBasis.random_init(
            system.dim(),
            n_basis=n_basis,
            offsets=offsets,
            variance=variance,
        ...
        psi0_basis = UnnormalizedBetaBasis.random_init(
            system.dim(),
            n_basis=n_basis,
            offsets=offsets,
            variance=variance,
