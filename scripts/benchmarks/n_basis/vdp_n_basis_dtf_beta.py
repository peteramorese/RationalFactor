...
N_BASIS_VALUES = [50, 100, 200, 500, 1000]
...
def main() -> None:
    ...
    for n_basis in N_BASIS_VALUES:
        contexts.append(
            {
                "name": f"n_basis_{n_basis}_wo_nftf",
                "params": {**CONTEXT_USE_NFTF_FALSE, "n_basis": n_basis},
            }
        )
    for n_basis in N_BASIS_VALUES:
        contexts.append(
            {
                "name": f"n_basis_{n_basis}_w_nftf",
                "params": {**CONTEXT_USE_NFTF_TRUE, "n_basis": n_basis},
            }
        )
