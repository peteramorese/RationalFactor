...
N_BASIS_VALUES = (200, 300, 400, 500, 1000)
...
def main() -> None:
    ...
    def experiment(
        ...
        if use_dtf:
            belief_seq = [
                CompositeDensityModel([trained_nftf, trained_domain_tf], belief) for belief in base_belief_seq
            ]
        else:
